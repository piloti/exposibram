...
<main id="primary" class="site-main">
    <section class="banner-home">
        <div class="owl-carousel owl-carousel-internal">
            <?php foreach (get_field('add_slider') as $key => $value) : ?>
                <div class="item">
    ...
    <?php if (get_field('number_whatsapp') != "") { ?>
        <a href="https://api.whatsapp.com/send?phone=<?php the_field("number_whatsapp"); ?>" target="_blank" rel="noopener noreferrer" class="btn-whatsapp">
...
<script>
    $('.owl-carousel-internal').owlCarousel({
        loop: true,
        margin: 0,
        nav: true,
        dots: false,
