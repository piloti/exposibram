 ...
 *
 * @package WordPress
 * @subpackage exposibram
 * @since Exposibram 1.0
 */
...
if ( function_exists( 'register_block_pattern_category' ) ) {
	 ...
	 * @return void
	 */
	function exposibram_register_block_pattern_category() {
		register_block_pattern_category(
			'twentytwentyone',
			array( 'label' => esc_html__( 'Exposibram', 'twentytwentyone' ) )
		);
	}
	add_action( 'init', 'exposibram_register_block_pattern_category' );
}
...
if ( function_exists( 'register_block_pattern' ) ) {
	 ...
	 * @return void
	 */
	function exposibram_register_block_pattern() {
	...
	add_action( 'init', 'exposibram_register_block_pattern' );
}
